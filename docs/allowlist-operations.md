...
v1.2.1 的默认集合按服务维护，覆盖常见的 AI、Google/YouTube、社交通信、流媒体、
开发协作、海外新闻与知识站点。为优先保证稳定性，还覆盖常见的共享 CDN、云平台、
登录、支付、监控与客服基础设施；根域名会自动覆盖其子域名。

“中国大陆不可访问”会随地区、运营商和时间变化，因此默认集合是常用服务基线，不是
对所有受限网站的永久穷举。缺失服务仍应通过管理 API 增加其第一方根域名。共享
基础设施规则会扩大代理流量与带宽消耗，这是为稳定性做出的明确取舍。
